(()=>{
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    form.addEventListener('submit',async event=>{
      ...
      status.className='form-status is-error';status.textContent=copy.demoInactive;submit.disabled=false
    });
  });
})();
